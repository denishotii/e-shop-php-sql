<?php
    ...
    */
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="esd-block-text es-p15t es-p20b" align="left">
                                                                                            <p style="font-size: 16px; color: #777777;">Hi '.$Name.', We are happy to recive from you this order and happy to send it to you.<br><span style="color:red;">Please verify your order in the phone and your order will be confirmed and ready for shipping!</span><br></p>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
                                                                            </table>
    ...
    if(!$mail->send()){
        ...
        header("Location: purchaseEmailToMe.php");
}
?>